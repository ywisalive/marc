...
<body class="bg-dark">
    <div class="container text-center">
        <div class="mt-5 mb-3">
            <img src="Recursos\logo.png" alt="" width="200px">
        </div>
        <div>
            <h2>Tela de Login</h2>
            ...
            <form action="Web/login.php" method="post">
                ...
                <input class="form-control mb-3" type="email" name="user" id="usuario" require>
                
                <label class="form-label bg-light" for="pass">Senha</label>
                <input class="form-control mb-3" type="password" name="senha" id="pass">
